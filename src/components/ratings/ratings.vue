<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect @contenttoggle="toggle" @ratingtypeselect="select" :select-type="selectType" :only-content="onlyContent" :ratings="ratings"></ratingselect>
          ...
          <li v-for="rating in ratings" v-show="needShow(rating.rateType,rating.text)" class="rating-item border-1px">
            ...
            <div class="content">
              ...
              <div class="recommend" >
                ...
                <template v-show="rating.recommend && rating.recommend.length">
